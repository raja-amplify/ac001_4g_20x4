...
unsigned char cid1[7] = {0X5A, 0XA5, 0X04, 0X82, 0X55, 0X00, 0X00};
unsigned char cid2[7] = {0X5A, 0XA5, 0X04, 0X82, 0X33, 0X00, 0X00};
unsigned char cid3[7] = {0X5A, 0XA5, 0X04, 0X82, 0X35, 0X00, 0X00};
